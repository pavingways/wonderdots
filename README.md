# Wonder Dots - Astro SAAS Starter Website Template

Wonder Dots is a free starter astro website template for saas, startups, marketing websites, landing pages & blogs. Built with Astro & TailwindCSS.
...
## Upgrade to Wonder Dots Pro Version

**[https://wonderdots-pro.web3templates.com/](https://wonderdots-pro.web3templates.com/)**

**[Purchase Wonder Dots Pro — $49](https://web3templates.com/templates/wonderdots-pro-astro-saas-website-template)**
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/surjithctly/wonderdots)
...
![preview](https://github.com/surjithctly/wonderdots/assets/1884712/25665c02-d2a7-43dc-89b2-34a8ae37ade9)
...
If you are reading this on github, you can click on the "Use this template" button above to create a new repository from wonderdots to your account. Then you can do a `git clone` to clone it to your local system.
...
```bash
git clone https://github.com/surjithctly/wonderdots.git myProjectName
# or
git clone https://github.com/surjithctly/wonderdots.git .
```
